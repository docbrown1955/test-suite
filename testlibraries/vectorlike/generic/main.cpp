...
int main() {
    ...
    model_params.model5  = #MODEL5;
    model_params.model6  = #MODEL6;
    model_params.model7  = #MODEL7;
    model_params.model8  = #MODEL8;
    model_params.model9  = #MODEL9;
    model_params.model10 = #MODEL10;
    model_params.model11 = #MODEL11;
    ...
    calculateMixingCoefficients(model, lib, "#Q1", "#Q2", BosonFilter::#BOSONFILTER);
    lib.print();

    vl::setupLibrary("#LIBRARYNAME", masses);
